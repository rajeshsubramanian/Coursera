	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		submitButton.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				// TODO - Get Priority
				int checkedPriorityButtonId = mPriorityRadioGroup
						.getCheckedRadioButtonId();
				Priority priority = null;
				switch (checkedPriorityButtonId) {
				...
				// TODO - Get Status
				int statusButtonId = mStatusRadioGroup
						.getCheckedRadioButtonId();
				Status status = null;
				switch (statusButtonId) {
				...
				case R.id.statusNotDone:
					...
					break;
				default:
					Log.d("WTF", "Should never see this");
				}
